...
curl \
-X POST -H "Content-Type: application/json" \
--data '{ "query": "{ addItem(id: \"002\", name: \"flowerpot\", price:15, quantity:3){ id name price quantity} }" }' \
http://localhost:3000/dev/graphql
...
curl \
-X POST -H "Content-Type: application/json" \
--data '{ "query": "{ addItem(id: \"002\", name: \"flowerpot\", price:20, quantity:3){ id name price quantity} }" }' \
http://localhost:3000/dev/graphql
echo "------------------------------------------------------------------"
